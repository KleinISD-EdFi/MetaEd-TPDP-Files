# Staff Association Extension Interchange

# Overview

This interchange defines staff and teacher information. It can be used to define

                   employment, assignment, and teaching associations, as well as staff positions
...
The Staff Association Extension Interchange can be used to:  
...
The following figure shows a logical view of the Staff Association Extension Interchange schema:  

![Staff Association Extension model details diagram](img/InterchangeStaffAssociationExtension-interchange-brief.png)


# Entities

The following table describes the primary entities of which the Staff Association Extension Interchange is composed.  
