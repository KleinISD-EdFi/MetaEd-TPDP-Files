...
BEGIN TRANSACTION
GO
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'edfi.FederalLocaleCodeType') AND name = N'UX_FederalLocaleCodeType_Id')
CREATE UNIQUE NONCLUSTERED INDEX UX_FederalLocaleCodeType_Id ON edfi.FederalLocaleCodeType
(Id) WITH( PAD_INDEX = ON, FILLFACTOR = 100, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
GO
COMMIT
